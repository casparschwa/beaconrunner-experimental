...
def process_attestation(state: BeaconState, attestation: Attestation) -> None:
    ...
    if data.target.epoch == get_current_epoch(state):
        print("if-statement: target epoch: {}, source epoch: {}, current_justified_checkpoint epoch: {}, previous_justified_checkpoint epoch: {}".format(data.target.epoch, data.source.epoch, state.current_justified_checkpoint.epoch, state.previous_justified_checkpoint.epoch))
        assert data.source == state.current_justified_checkpoint
        state.current_epoch_attestations.append(pending_attestation)
    else:
        print("else-statement: target epoch: {}, source epoch: {}, current_justified_checkpoint epoch: {}, previous_justified_checkpoint epoch: {}".format(data.target.epoch, data.source.epoch, state.current_justified_checkpoint.epoch, state.previous_justified_checkpoint.epoch))
