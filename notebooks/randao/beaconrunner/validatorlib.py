...
def randao_propose(validator, known_items, scenario="honest"):
    ...
    is_last_slot = True if (validator.data.slot + 1) % SLOTS_PER_EPOCH == 0 else False

    if is_last_slot == False or scenario == "honest":
        honest_propose(validator, known_items)
...
### HELPER FUNCTION FROM PYTEST SUITE
